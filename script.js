...
function setdata() {
    ...
    document.querySelector('.badge h5').textContent = users[curr].pendingMessagevalue.length;
    ...
    // let cardmessagedata1 = document.querySelector(".cardmessage-data img");
    // let cardmessagedata2 = document.querySelector(".cardmessage-data p");
...
// let videocard = document.querySelector(".video-calling-card");
// videocard.addEventListener("click",function(){
//    videocard.classList.remove("z-[1]");
...
callingicon.addEventListener("click", function () {
    ...
    videocard.classList.add("z-[8]");
    videocard.classList.add("block");

    setTimeout(() => {
        videocard.classList.remove("z-[8]");
        videocard.classList.add("z-[1]");

        videocard.classList.remove("block");
...
// cardmessagedata1.src = users[curr].profilePic;
// // cardmessagedata2.textContent ='newdata' ;
